levels = [
    ["SOK", "OFE", "AIN"],
    ["EGASUSETSE", "PAMSAAKEAI", "TSAROCNRKP", "ARCANEAHAD", "NASCISPINU", "KINHEEKEID", "STIDINGTRG", "YKCDRRTTBE", "TFEUEUSLEI", "OFEPHTNANN"],
]
wordLists = [
    ["SOFIA", "NEKO"],
    ["STEAKPIE", "MACARONICHEESE", "SAUSAGEPASTA", "PANCAKES", "RHADUNI", "RANKINS", "KETTLEBRIDGEINN", "STICKYTOFFEEPUDDING", "ANSTRUTHER"],
]
themes = [
    "Pets",
    "Food",
